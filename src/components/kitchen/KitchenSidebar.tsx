import { CreditCard, Clock, ChefHat, Package, Calculator, Tag, LayoutGrid } from "lucide-react";
...
export type KitchenView = "paid" | "pending" | "stock" | "calculator" | "discounts" | "menu-cards";
